...
import { Unlink, ArrowLeft, House } from 'lucide-react';
...
export const NotFound: React.FC<UnauthorizedProps> = ({
  title = "Page Not Found",
  message = "This page could not be found. If you believe this is an error, please contact the administration.",
  homePath = "/",
}) => {
